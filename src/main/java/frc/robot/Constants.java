...
public final class Constants {
  ...
  public static final class Controle {
    ...
    public static final int driverControle = 0;
    public static final int operatorControle= 1;
  ...
  public static final class Tracao {
    ...
    public static final double multiplicadorR2ButtonX = 0.2;
    public static final double multiplicadorR2ButtonY = 0.2;
